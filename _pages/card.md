...
<style>
  ...
  @media (max-width: 520px) {
    .card-terminal { margin: 2vh auto; padding: 16px 14px; max-width: 96vw; }
    .card-id { flex-direction: column; align-items: flex-start; gap: 12px; margin-left: 8px; }
    .card-id__avatar { width: 72px; height: 72px; }
    .card-id__lines { font-size: 13px; }
    .card-links { margin-left: 8px; }
    .card-link {
    ...
    .card-link__perm { display: none; }
    .card-link__name { display: none; }
  }
</style>
