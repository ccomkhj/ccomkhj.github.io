...
tags:
   - Programing
classes: wide  
title: "Kubenetics Handbooks"
---

This is the list of commands that I often use.

Absolutely — here’s a clean, ready-to-save **Markdown summary** of essential `kubectl` commands for quick reference.

You can copy this into a `k8s-cheatsheet.md` or keep it as your terminal note. 👇
